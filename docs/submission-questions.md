...
S7.7 50건 representative subset은 schema-valid 100%(50/50), micro precision 99.74%, micro recall 99.74%, `detail_type` precision/recall 100.00%, `size_info` precision/recall 100.00%, dedup accuracy 100.00%를 기록했습니다. S7.8 `size_info` 표기 패턴 48건은 schema-valid 100%(48/48), `size_info` precision/recall 100.00%, TP/FP/FN 97/0/0, `recommendation_noise` false positive 0건을 기록했습니다. 합성 self-check는 precision/recall 100.00%이지만 blind extraction 성능이 아니라 coverage/self-check이며, 실제 공개 snippet은 자동 fetch 없이 짧은 factual snippet만 사용했고 법적 적합/부적합 판정은 하지 않았습니다.
