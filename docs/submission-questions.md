...
S7.7 50건 representative subset은 schema-valid 100%(50/50), micro precision 100.00%, micro recall 100.00%, `detail_type` precision/recall 100.00%, `materials` precision/recall 100.00%, `size_info` precision/recall 100.00%, dedup accuracy 100.00%를 기록했습니다. S7.8 `size_info` 표기 패턴 48건은 schema-valid 100%(48/48), `size_info` precision/recall 100.00%, TP/FP/FN 97/0/0, `recommendation_noise` false positive 0건을 기록했습니다. 합성 self-check는 precision/recall 100.00%이지만 blind extraction 성능이 아니라 coverage/self-check이며, 실제 공개 snippet은 자동 fetch 없이 짧은 factual snippet만 사용했고 탐색 비교 micro precision 65.48%, micro recall 77.46%를 기록했습니다. 이 snippet 수치는 전체 성능 기준이 아니라 정보 부족 리스크 확인용이며, 법적 적합/부적합 판정은 하지 않았습니다.
